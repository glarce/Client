...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"modules/video/index.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.loadModuleConfig = loadModuleConfig;
exports.default = void 0;
let videoConfig = {};

function loadModuleConfig(config) {
  videoConfig = config;
}
...
},{}],"functions/stringToHTML.js":[function(require,module,exports) {
"use strict";
...
},{}],"modules/aframe/index.js":[function(require,module,exports) {
"use strict";
...
var _stringToHTML = _interopRequireDefault(require("../../functions/stringToHTML"));
...
class AFrame {
  ...
  get element() {
    ...
    return (0, _stringToHTML.default)(this.config.aframeData.aframe);
  }

}

exports.default = AFrame;
},{"../../functions/stringToHTML":"functions/stringToHTML.js"}],"app.js":[function(require,module,exports) {
"use strict";
...
exports.default = App;
},{"./modules/video":"modules/video/index.js","./modules/aframe":"modules/aframe/index.js"}],"../node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
(async () => {
  const data = await require("_bundle_loader")(require.resolve('./app.json'));
  const app = new _app.default(data);
  await app.init();
})();
},{"./app.js":"app.js","_bundle_loader":"../node_modules/parcel-bundler/src/builtins/bundle-loader.js","./app.json":[["app.45df78bb.js","app.json"],"app.45df78bb.js.map","app.json"]}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
